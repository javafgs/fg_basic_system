var $FG = (function () {
    ...
    //异步请求
    function _sendRequestAsync(url,type,data) {
        $.ajax({
            async:true,
            url:url,
            type:type,
    ...
    //同步请求
    function _sendRequestSync(url,type,data) {
        var data="";
        $.ajax({
            async:false,
            url:url,
    ...
    return {
        ...
        sendRequestAsync: function(url,type,data){
            _sendRequestAsync(url,type,data)
        },
        sendRequestSync: function(url,type,data){
            _sendRequestSync(url,type,data)
        },
